...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  render: function render(h) {
	    ...
	    var view = h(this.tag, {
	      class: ['fezlay-scrollbar__view', this.viewClass],
	    ...
	    var wrap = h(
	      'div',
	      {
	        ...
	        'class': [this.wrapClass, 'fezlay-scrollbar__wrap', gutter ? '' : 'fezlay-scrollbar__wrap--hidden-default'] },
	      [[view]]
	    );
	    var nodes = void 0;
	    ...
	    if (!this.native) {
	      ...
	      nodes = [h(
	        ...
	        {
	          ref: 'wrap',
	          'class': [this.wrapClass, 'fezlay-scrollbar__wrap'],
	          style: style },
	        [[view]]
	      )];
	    }
	    return h('div', { class: 'fezlay-scrollbar' }, nodes);
	  },
	...
	exports.default = {
	  ...
	  render: function render(h) {
	    ...
	    return h(
	      'div',
	      {
	        'class': ['fezlay-scrollbar__bar', 'is-' + bar.key],
	        on: {
