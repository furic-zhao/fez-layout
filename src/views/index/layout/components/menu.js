	        ...
	        var data = {
	          ...
	          on: {
	            ...
	            enter: function enter(el) {
	              (0, _dom.addClass)(el, 'fezlay-opacity-transition');
	              el.style.opacity = 1;
	            },
	            afterEnter: function afterEnter(el) {
	              (0, _dom.removeClass)(el, 'fezlay-opacity-transition');
	              el.style.opacity = '';
	            },
	            beforeLeave: function beforeLeave(el) {
	              if (!el.dataset) el.dataset = {};

	              if ((0, _dom.hasClass)(el, 'fezlay-menu--collapse')) {
	                (0, _dom.removeClass)(el, 'fezlay-menu--collapse');
	                el.dataset.oldOverflow = el.style.overflow;
	                el.dataset.scrollWidth = el.scrollWidth;
	                (0, _dom.addClass)(el, 'fezlay-menu--collapse');
	              }
...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('el-menu-collapse-transition', [_c('ul', {
	    ...
	    class: {
	      'fezlay-menu--horizontal': _vm.mode === 'horizontal',
	        'fezlay-menu--dark': _vm.theme === 'dark',
	        'fezlay-menu--collapse': _vm.collapse
	    }
	  }, [_vm._t("default")], 2)])
	},staticRenderFns: []}
