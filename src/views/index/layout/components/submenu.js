	...
	exports.default = {
	  computed: {
	    indexPath: function indexPath() {
	      ...
	      while (parent.$options.componentName !== 'fezMenu') {
	        if (parent.index) {
	    ...
	    rootMenu: function rootMenu() {
	      var parent = this.$parent;
	      while (parent && parent.$options.componentName !== 'fezMenu') {
	        parent = parent.$parent;
	      }
	      return parent;
	    },
	    parentMenu: function parentMenu() {
	      var parent = this.$parent;
	      while (parent && ['fezMenu', 'fezSubmenu'].indexOf(parent.$options.componentName) === -1) {
	        parent = parent.$parent;
	      }
	      return parent;
	    },
	    paddingStyle: function paddingStyle() {
	      ...
	      if (this.rootMenu.collapse) {
	        ...
	        while (parent && parent.$options.componentName !== 'fezMenu') {
	          if (parent.$options.componentName === 'fezSubmenu') {
	            padding += 20;
	          }
	          parent = parent.$parent;
	        }
	...
	exports.default = {
	  ...
	  computed: {
	    menuTransitionName: function menuTransitionName() {
	      return this.rootMenu.collapse ? 'fezlay-zoom-in-left' : 'fezlay-zoom-in-top';
	    },
	  ...
	  methods: {
	    ...
	    handleClick: function handleClick() {
	      ...
	      this.dispatch('fezMenu', 'submenu-click', this);
	    },
...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('li', {
	    ...
	    ref: "submenu-title",
	    staticClass: "fezlay-submenu__title",
	    ...
	    class: {
	      'fezlay-submenu__icon-arrow': true,
	      'fa fa-angle-bottom': _vm.rootMenu.mode === 'horizontal',
	        'fa fa-angle-down': _vm.rootMenu.mode === 'vertical' && !_vm.rootMenu.collapse,
	        'fa fa-angle-right': _vm.rootMenu.mode === 'vertical' && _vm.rootMenu.collapse
	    }
